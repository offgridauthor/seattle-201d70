...
function multiply(a, b) { //eslint-disable-line
  var multNum = a * b;
  var message = `The product of ${a} and ${b} is ${multNum}.`;
  //  console.log(message);
  return [multNum, message];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var thisSumTotal = sum(firstSum, c)[0];

  //console.log(thisSumTotal);

  var thisSumMessage = `${a},${b},${c} was passed in as an array of numbers, and ${thisSumTotal} is their sum.`;

  return [thisSumTotal, thisSumMessage];
  //
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var firstMult = multiply(d, e)[0];
  var thisMultTotal = multiply(firstMult, f)[0];

  // console.log(thisMultTotal);

  var productString = `The numbers ${d},${e},${f} have a product of ${thisMultTotal}.`;


  return [thisMultTotal, productString];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  var multMess = `The numbers ${listArray} have a product of ${mult}.`;
// console.log(multMess);
